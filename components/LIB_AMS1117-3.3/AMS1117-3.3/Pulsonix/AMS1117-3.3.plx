...
(library Library_1
	...
	(compDef "AMS1117-3.3" (originalName "AMS1117-3.3") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "GND/ADJ") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-28/DSA-550594.pdf")
		(attr "<Component Height>" "1.8")
		(attr "<STEP Filename>" "AMS1117-3.3.stp")
		(attr "<STEP Offsets>" "X=0;Y=0;Z=1.22")
