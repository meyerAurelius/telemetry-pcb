...
//2457653/1875749/2.50/2/2/Capacitor
...
(library Library_1
	...
	(symbolDef "C0603C103F3GECTU" (originalName "C0603C103F3GECTU")
	...
	(compDef "C0603C103F3GECTU" (originalName "C0603C103F3GECTU") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "C0603C103F3GECTU"))
		...
		(attr "Manufacturer_Part_Number" "C0603C103F3GECTU")
		(attr "Mouser Part Number" "80-C0603C103F3GEC")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/KEMET/C0603C103F3GECTU?qs=Mv7BduZupUjWMY5EogEjUg%3D%3D")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "ESD SMD Comm C0G, Ceramic, 0.01 uF, 1%, 25 VDC, 62.5 VDC, 125C, -55C, C0G, SMD, MLCC, Temperature Stable, Electro Static Discharge, Class I, 0.1 % , 100 GOhms, 3.7 mg, 0603, 1.6mm, 0.8mm, 0.8mm, 0.7mm, 0.35mm, 4000, 78  Weeks, 120")
		(attr "<Hyperlink>" "https://content.kemet.com/datasheets/KEM_C1003_C0G_SMD.pdf")
		(attr "<Component Height>" "0.87")
		(attr "<STEP Filename>" "C0603C103F3GECTU.stp")
