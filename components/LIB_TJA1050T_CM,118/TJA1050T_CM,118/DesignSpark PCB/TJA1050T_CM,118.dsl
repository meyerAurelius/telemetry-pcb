SamacSys ECAD Model
1063870/1875749/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TJA1050T_CM_118" (originalName "TJA1050T_CM_118")
	...
	(compDef "TJA1050T_CM,118" (originalName "TJA1050T_CM,118") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "VREF") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TJA1050T_CM_118"))
		...
		(attr "Manufacturer_Part_Number" "TJA1050T/CM,118")
		(attr "Mouser Part Number" "771-TJA1050T/CM118")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/NXP-Semiconductors/TJA1050T-CM118?qs=5XOdhvmYM0NFFspw0VP5sA%3D%3D")
		(attr "Arrow Part Number" "TJA1050T/CM,118")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tja1050tcm118/nxp-semiconductors?utm_currency=USD&region=nac")
		(attr "Description" "NXP - TJA1050T/CM,118 - CAN TRANSCEIVER, 1TX/RX, SOIC-8")
		(attr "Datasheet Link" "http://www.nxp.com/docs/en/data-sheet/TJA1050.pdf")
		(attr "Height" "1.75 mm")
	)
