...
(library Library_1
	...
	(patternDef "LEDM2012X70N" (originalName "LEDM2012X70N")
		(multiLayer
	...
	(compDef "150080GS75000" (originalName "150080GS75000") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attachedPattern (patternNum 1) (patternName "LEDM2012X70N")
			(numPads 2)
			(padPinMap
		...
		(attr "Description" "WL-SMCW SMT Mono-Color Chip LED Waterclear 0805, Green Typ.(@20mA): 520nm, 450mcd, 3.2V, 140 InGaN")
		(attr "Datasheet Link" "https://www.we-online.com/components/products/download/Download_3D_150080GS75000+%28rev1%29.pdf")
		(attr "Height" "0.7 mm")
	)
