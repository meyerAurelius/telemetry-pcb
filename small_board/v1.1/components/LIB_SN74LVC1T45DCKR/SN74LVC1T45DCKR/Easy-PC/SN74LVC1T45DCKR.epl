...
(library Library_1
	...
	(compDef "SN74LVC1T45DCKR" (originalName "SN74LVC1T45DCKR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "VCCB") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "DIR") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "B") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/sn74lvc1t45")
		(attr "Height" "1.1 mm")
	)
