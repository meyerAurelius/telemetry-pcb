...
//416608/1875749/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SN74LVC1T45DCKR" (originalName "SN74LVC1T45DCKR")
	...
	(compDef "SN74LVC1T45DCKR" (originalName "SN74LVC1T45DCKR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "VCCB") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "DIR") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "B") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SN74LVC1T45DCKR"))
		...
		(attr "Manufacturer_Part_Number" "SN74LVC1T45DCKR")
		(attr "Mouser Part Number" "595-SN74LVC1T45DCKR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/SN74LVC1T45DCKR?qs=gb35HGp1gQLgs5JLyVnp7g%3D%3D")
		(attr "Arrow Part Number" "SN74LVC1T45DCKR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/sn74lvc1t45dckr/texas-instruments?region=nac")
		(attr "Description" "Texas Instruments SN74LVC1T45DCKR, Bus Transceiver Non-Inverting LVTTL, 1.65  5.5 V, 6-Pin SC-70")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/sn74lvc1t45")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "SN74LVC1T45DCKR.stp")
