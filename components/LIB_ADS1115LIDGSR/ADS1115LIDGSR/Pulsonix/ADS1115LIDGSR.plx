...
//19146862/1875749/2.50/10/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ADS1115LIDGSR" (originalName "ADS1115LIDGSR")
	...
	(compDef "ADS1115LIDGSR" (originalName "ADS1115LIDGSR") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADS1115LIDGSR"))
		...
		(attr "Manufacturer_Part_Number" "ADS1115LIDGSR")
		(attr "Mouser Part Number" "595-ADS1115LIDGSR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/ADS1115LIDGSR?qs=mELouGlnn3cukRGa5QBtug%3D%3D")
		(attr "Arrow Part Number" "ADS1115LIDGSR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/ads1115lidgsr/texas-instruments?utm_currency=USD&region=nac")
		(attr "Description" "Analog to Digital Converters - ADC 16-bit, 860-SPS four-channel delta-sigma ADC with PGA, comparator and 1.8-V IC bus voltage support 10-VSSOP -40 to 125")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/ads1115l.pdf?ts=1719994580469&ref_url=https%253A%252F%252Fwww.ti.com%252Fsitesearch%252Fen-us%252Fdocs%252Funiversalsearch.tsp%253FlangPref%253Den-US")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "ADS1115LIDGSR.stp")
